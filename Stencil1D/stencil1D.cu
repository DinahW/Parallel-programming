...
{
    __shared__ int temp[BLOCK_SIZE + 2 * RADIUS]; /* FIXME #2*//FIXED

    int gindex = threadIdx.x + blockIdx.x * blockDim.x + RADIUS; /* FIXME #3*//FIXED
    int lindex = threadIdx.x + RADIUS; /* FIXME #4 *//FIXED
